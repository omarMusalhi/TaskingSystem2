...
namespace TaskingSystem2.Areas.Admin.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Department.Include(d => d.Directorate);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DirectorateId")] Department department)
        {
            ...
            ViewData["DirectorateId"] = new SelectList(_context.Directorate, "Id", "Name", department.DirectorateId);
            return View(department);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DirectorateId")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
